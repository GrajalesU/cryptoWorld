        ...
        <div className="Detail_Price">
          ...
          <div className="Detail_Price_Percentage">
            {currency.percent_change_24h >= 0
              ? (<><span className="material-icons">arrow_drop_up</span> {currency.percent_change_24h}%</>)
              : (<><span className="material-icons">arrow_drop_down</span> {currency.percent_change_24h}%</>)}
          </div>
        </div>
